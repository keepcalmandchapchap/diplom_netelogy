# Generated by Django 5.2 on 2025-08-05 19:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='address', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
                'verbose_name': 'Адрес',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='item', to='shop_api.item', verbose_name='Товар')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='order', to='shop_api.address', verbose_name='Адрес')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='item_order', to='shop_api.item', verbose_name='Товар')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_item', to='shop_api.order', verbose_name='Заказ')),
            ],
        ),
        migrations.AddField(
            model_name='order',
